<template>
  <div class="md:flex-col w-full md:w-3/12 mr-8">
    <nav class="bg-white dark:bg-gray-700 rounded-lg p-4 mb-4">
      ...
      <ApolloQuery
        :query="gql => gql(`
          query ProjectQuery ($uuid: ID!) {
            allProjects (userUuid: $uuid) {
              uuid
              slug
              name
              url
      ...
      >
        ...
        >
          <div
            v-if="data.allProjects.length || $accessor.isAuthenticated && $accessor.getAuthUser.username === $route.params.username"
          >
            <h2
          ...
          <ul
            :class="{
              'mt-2 border-t border-gray-300 dark:border-gray-600 pt-4': data.allProjects.length || $accessor.isAuthenticated && $accessor.getAuthUser.username === $route.params.username
            }"
            class="w-full"
          >
            <li class="mb-1">
