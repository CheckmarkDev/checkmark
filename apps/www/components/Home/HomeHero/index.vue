      ...
      <div class="flex items-center text-center flex-col py-8">
        ...
        >
          <nuxt-link
            ...
            class="inline-block bg-white rounded text-blue-500 p-4 font-medium text-base hover:bg-gray-200 hover:shadow-sm mr-4"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            class="flex bg-white rounded text-blue-500 p-4 hover:bg-gray-200 hover:shadow-sm"
          >
            <svg
              width="24"
              height="24"
