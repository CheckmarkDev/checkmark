...
class EmailNotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email_notification" do
    assert_difference('EmailNotification.count') do
      post email_notifications_url, params: { email_notification: { comment: @email_notification.comment, like: @email_notification.like, newsletter: @email_notification.newsletter, user_id: @email_notification.user_id } }, as: :json
    end
  ...
  test "should update email_notification" do
    patch email_notification_url(@email_notification), params: { email_notification: { comment: @email_notification.comment, like: @email_notification.like, newsletter: @email_notification.newsletter, user_id: @email_notification.user_id } }, as: :json
    assert_response 200
  end
