...
class TaskLikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_like" do
    assert_difference('TaskLike.count') do
      post task_likes_url, params: { task_like: { task_id: @task_like.task_id, user_id: @task_like.user_id } }, as: :json
    end
  ...
  test "should update task_like" do
    patch task_like_url(@task_like), params: { task_like: { task_id: @task_like.task_id, user_id: @task_like.user_id } }, as: :json
    assert_response 200
  end
