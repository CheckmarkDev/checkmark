...
class TaskCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_comment" do
    assert_difference('TaskComment.count') do
      post task_comments_url, params: { task_comment: { task_id: @task_comment.task_id, user_id: @task_comment.user_id } }, as: :json
    end
  ...
  test "should update task_comment" do
    patch task_comment_url(@task_comment), params: { task_comment: { task_id: @task_comment.task_id, user_id: @task_comment.user_id } }, as: :json
    assert_response 200
  end
